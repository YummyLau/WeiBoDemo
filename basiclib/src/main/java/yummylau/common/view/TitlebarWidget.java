...
import yummylau.common.databinding.LibraryWidgetTitlebarLayoutBinding;
...
public class TitlebarWidget extends FrameLayout implements View.OnClickListener {
    ...
    private LibraryWidgetTitlebarLayoutBinding binding;
    ...
    public TitlebarWidget(Context context, AttributeSet attrs, int defStyle) {
        ...
        binding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.library_widget_titlebar_layout, this, true);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.ll_titlebar_back_btn){
            finishActivity();
        }
    }
